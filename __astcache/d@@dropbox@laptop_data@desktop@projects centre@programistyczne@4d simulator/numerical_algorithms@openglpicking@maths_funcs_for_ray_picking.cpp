...
\******************************************************************************/
#include "maths_funcs_for_ray_picking.h"
#include <stdio.h>
...
mat4 perspective( float fovy, float aspect, float near1, float far1 )
{
	...
	float sz = -( far1 + near1 ) / ( far1 - near1 );

	float pz = -( 2.0f * far1 * near1 ) / ( far1 - near1 );
