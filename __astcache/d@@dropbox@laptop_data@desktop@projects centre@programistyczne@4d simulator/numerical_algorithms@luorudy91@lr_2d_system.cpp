...
//************************************************************************
int LR_91_2D_system_class::create_grid(int x, int y)
{
/*
    int i;
...
//************************************************************************
int LR_91_2D_system_class::destroy_grid()
{
/*
    int i;
    for(i=0;i<X;i++)
...
//************************************************************************
void LR_91_2D_system_class::calculate_N_steps(int steps_number, int if_tip)
{
...
//-------------------------------------------------------------------
int LR_91_2D_system_class::record_potentials()
{
    for(long x=0;x<X;x++)
