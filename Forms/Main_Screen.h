...
__published:	// IDE-managed Components
	...
	TEdit *Playback_Speed_Edit;
	TButton *Play_Button;
	TLabel *T_Label;
	TButton *Stop_Playback_Button;
	TButton *Calculate_MPC_Button;
	TPopupMenu *PopupMenu_mpc_vs_dist;
	TMenuItem *SaveXYpointstocsvfile1;
	TCheckBox *Ectopy_In_Middle_CheckBox;
	TLabel *Label59;
	TEdit *Ectopy_CL_ms_Edit;
	...
	void __fastcall Stop_Playback_ButtonClick(TObject *Sender);
	void __fastcall Clear_Sig_History_ButtonClick(TObject *Sender);
	void __fastcall SaveXYpointstocsvfile1Click(TObject *Sender);
