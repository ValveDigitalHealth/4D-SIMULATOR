...
struct POINT3DXYZ {
	...
	friend POINT3DXYZ operator-(const POINT3DXYZ& pt3dPoint1, const POINT3DXYZ& pt3dPoint2);
	friend POINT3DXYZ operator*(const POINT3DXYZ& pt3dPoint, double fScale);
	friend POINT3DXYZ operator*(double fScale, const POINT3DXYZ& pt3dPoint);
	friend POINT3DXYZ operator/(const POINT3DXYZ& pt3dPoint, double fScale);
	friend POINT3DXYZ& operator*=(POINT3DXYZ& pt3dPoint, double fScale);
	friend POINT3DXYZ& operator/=(POINT3DXYZ& pt3dPoint, double fScale);
...
template <class T> class CIsoSurface
{
	...
	void GenerateSurface(const T* ptScalarField, T tIsoLevel, unsigned int nCellsX, unsigned int nCellsY,  unsigned int nCellsZ,
