...
class Simulation_System_Class
{
	...
	/** 2D SYSTEM **/
	/** 2D SYSTEM **/
	FHN_2D_system_class Two_Dim_System;    AnsiString Model_Name = "FitzHugh-Nagumo model";
//	TP1A_2D_system_class Two_Dim_System;   AnsiString Model_Name = "Tussher-Panfilov model";
...
//	FHN_4D_system_class Four_Dim_System;
	...
	void calculate_velocity_field(double Cycle_Length_ms, int Grid_Spacing);
